...
#else
#define CAMERA_PIXEL_FORMAT PIXFORMAT_RGB565  /* the ONLY proven GC0308 QVGA format; luma extracted in GetImage */
#endif
/*
 ...
 */
#define CAMERA_FRAME_SIZE FRAMESIZE_QVGA  /* only QVGA/VGA are real on GC0308; downscale in GetImage */

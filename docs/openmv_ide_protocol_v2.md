> Note (2026-09-02): this is the **OpenMV Protocol V2** wire spec (the IDE/USB debug protocol), used by `fb_webui.py` and friends. It is not the device↔sensorhub contract; that is in [camera_standard.md](camera_standard.md) §4.
